...
public class MapView extends View
{
	...
	private PointF selectPoint = new PointF();
     ...
     */
    public static void setOriginPoint(PointF origin) {
        startPoint = origin;
    }
     ...
     */
    public static void setDestinationPoint(PointF destination) {
